...
public class KnoxCliLdapFuncTestNegative {
  ...
  public void testBadTopology() throws Exception {
    ...
    String args1[] = {"auth-test", "--master", "knox", "--cluster", "bad-cluster",
    ...
    String args2[] = {"auth-test", "--master", "knox", "--cluster", "bad-cluster",
        "--u", username, "--p", password, "--g" };
    cli.run( args2 );
    ...
    String args3[] = {"auth-test", "--master", "knox", "--cluster", "bad-cluster",
        "--u", username, "--p", password, "--g" };
    cli.run( args3 );
