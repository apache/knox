...
public class DefaultHaDispatchTest {
  ...
  public void testConnectivityFailover() throws Exception {
    ...
    descriptor.addServiceConfig(HaDescriptorFactory.createServiceConfig(serviceName, "true", "1", "1000", null, null, null, null));
  ...
  public void testConnectivityActive() throws Exception {
    String serviceName = "OOZIE";
    HaDescriptor descriptor = HaDescriptorFactory.createDescriptor();
    descriptor.addServiceConfig(HaDescriptorFactory.createServiceConfig(serviceName, "true", "1", "1000", null, null, "true", null));
    HaProvider provider = new DefaultHaProvider(descriptor);
