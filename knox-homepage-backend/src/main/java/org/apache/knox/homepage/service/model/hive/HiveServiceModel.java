...
public class HiveServiceModel extends ServiceModel {
  private static final String SERVICE = "HIVE";
  private static final String SHORT_DESCRIPTION = "Hive";
  private static final String DESCRIPTION = "The Apache Hive ™ data warehouse software facilitates reading, writing, and managing large datasets residing in distributed storage using SQL. "
