...
public class EmptyFederatedIdentitityService implements FederatedIdentityService {
    ...
    @Override
    public Optional<FederatedIdentity> findById(String identityId) {
        return Optional.empty();
    }

    @Override
    public Optional<FederatedIdentity> findByProviderAndSubject(String provider, String externalIssuer, String externalSubject) {
        return Optional.empty();
    }
