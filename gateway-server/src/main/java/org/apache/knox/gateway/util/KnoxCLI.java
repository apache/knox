...
public class KnoxCLI extends Configured implements Tool {
  ...
  private int init(String[] args) throws IOException {
    ...
    for (int i = 0; i < args.length; i++) { // parse command line
      if (args[i].equals("create-master")) {
        ...
        command = new CreateListAliasesCreateCommand();
        if (args.length < 3 || "--help".equals(alias)) {
          printKnoxShellUsage();
          return -1;
        }
        ...
        this.cluster = args[++i];
        if(command instanceof CreateListAliasesCreateCommand) {
          ((CreateListAliasesCreateCommand) command).toMap(this.cluster);
        }
  ...
  private void printKnoxShellUsage() {
    ...
    if ( command != null ) {
      ...
      out.println();
      out.println( div );
      out.println(CreateListAliasesCreateCommand.USAGE + "\n\n" + CreateListAliasesCreateCommand.DESC);
      out.println();
      out.println( div );
    }
  }
...
//         logAndValidateCertificate();
 ...
 public class AliasDeleteCommand extends Command {
  ...
  public class CreateListAliasesCreateCommand extends BatchAliasCreateCommand {
