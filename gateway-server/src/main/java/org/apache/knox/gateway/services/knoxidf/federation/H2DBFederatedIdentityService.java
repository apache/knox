...
/**
 * A self-provisioning, embedded-H2 backed {@link FederatedIdentityService}. This is the
 * auto-enabled default when KnoxIDF is deployed without an operator-configured external database,
 * mirroring how {@link H2DBTokenStateService} is the default token-state service. It replaces the
 ...
 * aliases exist, and then delegates all persistence to {@link JdbcFederatedIdentityService} (which
 * builds the {@link FederatedIdentityDatabase} and self-creates its tables).
 */
public class H2DBFederatedIdentityService extends JdbcFederatedIdentityService {
  ...
  public void init(GatewayConfig config, Map<String, String> options) throws ServiceLifecycleException {
    try {
      ...
      throw new ServiceLifecycleException("Error while initiating H2DBFederatedIdentityService: " + e, e);
    }
  }
