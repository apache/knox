...
function main {
   ...
   checkJava
   buildAppJavaOpts
$JAVA "${APP_JAVA_OPTS[@]}" -Dlog4j.configuration=conf/knoxshell-log4j.properties -javaagent:"$APP_BIN_DIR"/../lib/aspectjweaver.jar -cp bin/knoxshell.jar:lib/* org.apache.knox.gateway.shell.Shell "$@" || exit 1
