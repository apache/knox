...
public class GatewayDemoSecure {
  ...
  public void testLive() throws IOException {
    ...
    // "http://hadoop-secure.home:50070/webhdfs/v1/horton/changes?op=OPEN"
...
//    gatewayConfig.put( "path", "gateway" );
//
...
//    serviceConfig.put( "target", "http://hadoop-secure.home:50070/" );
//
...
//    serviceConfig.put( "class", HttpClientPivot.class.getName() );
//    serviceConfig.put( "target", "http://hadoop-secure.home:50070/dfshealth.jsp" );
//
//    filterConfig = new FilterConfig();
//    filterConfig.put( "class", UrlRewriteFilter.class.getName() );
//    serviceConfig.filters.put( "rewrite", filterConfig );
...
//    serviceConfig.put( "target", "http://hadoop-secure.home:50070/webhdfs" );
//
//    filterConfig = new FilterConfig();
...
//
//    filterConfig = new FilterConfig();
//    filterConfig.put( "class", JassLoginFilter.class.getName() );
