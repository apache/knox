...
public class TempletonDemo {
  ...
  public void demoGateway() throws IOException {
    ...
    demo( "http://localhost:8888/gateway/cluster/templeton/api/v1/mapreduce/jar" );
  }
  ...
  private void demo( String url ) throws IOException {
    ...
    parameters.add( new BasicNameValuePair( "jar", "wordcount/hadoop-examples.jar" ) );
    parameters.add( new BasicNameValuePair( "class", "org.apache.hadoop.examples.WordCount" ) );
