...
public abstract class AbstractJWTFilter implements Filter {
	...
	protected String verificationPEM;
	protected String thirdpartyPEMVIAJWKS;
	protected String thirdpartyjwkdAud;
	protected String thirdpartyTokenProvider;
	protected String thirdPartyPrincipalClaim;
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		if (context != null) {
			GatewayServices services = (GatewayServices) context
	...
	protected void continueWithEstablishedSecurityContext(Subject subject, final HttpServletRequest request,
		...
		if (context != null) {
			...
			String sourceUri = (String) request
	...
	protected static Subject createSubjectFromToken(JWT token) {
	...
	protected static Subject createSubjectFromToken(JWT token, String claim) {

		String principal = token.getSubject();
		String claimvalue = null;
		if (claim != null) {
			claimvalue = token.getClaim(claim);
		}
