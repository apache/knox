...
public class LivyForSpark4ServiceModelGeneratorTest extends AbstractServiceModelGeneratorTest {
  ...
  protected String getServiceType() {
    return LivyForSpark4ServiceModelGenerator.SERVICE_TYPE;
  }

  @Override
  protected String getRoleType() {
    return LivyForSpark4ServiceModelGenerator.ROLE_TYPE;
  }

  @Override
  protected ServiceModelGenerator newGenerator() {
    return new LivyForSpark4ServiceModelGenerator();
  }
