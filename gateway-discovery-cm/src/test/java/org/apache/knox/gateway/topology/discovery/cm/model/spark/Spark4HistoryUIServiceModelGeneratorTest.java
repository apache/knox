...
public class Spark4HistoryUIServiceModelGeneratorTest extends AbstractServiceModelGeneratorTest {
  ...
  protected String getServiceType() {
    return Spark4HistoryUIServiceModelGenerator.SERVICE_TYPE;
  }

  @Override
  protected String getRoleType() {
    return Spark4HistoryUIServiceModelGenerator.ROLE_TYPE;
  }

  @Override
  protected ServiceModelGenerator newGenerator() {
    return new Spark4HistoryUIServiceModelGenerator();
  }
