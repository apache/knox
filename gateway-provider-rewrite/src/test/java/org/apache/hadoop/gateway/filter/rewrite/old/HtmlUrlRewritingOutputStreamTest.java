...
public class HtmlUrlRewritingOutputStreamTest {
  ...
  private void assertMatch( Pattern pattern, String source, String expect ) {
    ...
    Assert.assertThat( matcher.find(), IsEqual.equalTo( true ) );
    String tag = matcher.group( 1 );
    Assert.assertThat( tag, IsEqual.equalTo( expect ) );
  }
  ...
  public void testAbsoluteUrlPattern() {
    ...
    Assert.assertThat( pattern.matcher( "/" ).matches(), IsEqual.equalTo( true ) );
    Assert.assertThat( pattern.matcher( "/x" ).matches(), IsEqual.equalTo( true ) );
    Assert.assertThat( pattern.matcher( "/x/y" ).matches(), IsEqual.equalTo( true ) );
    Assert.assertThat( pattern.matcher( "/x/y.jsp" ).matches(), IsEqual.equalTo( true ) );

    Assert.assertThat( pattern.matcher( "" ).matches(), IsEqual.equalTo( false ) );
    Assert.assertThat( pattern.matcher( "x" ).matches(), IsEqual.equalTo( false ) );
    Assert.assertThat( pattern.matcher( "x/y" ).matches(), IsEqual.equalTo( false ) );
    Assert.assertThat( pattern.matcher( "x/y.jsp" ).matches(), IsEqual.equalTo( false ) );
  }
  ...
  public void testCommentRewrite() {
    ...
    Assert.assertThat( matcher.matches(), IsEqual.equalTo( true ) );
    Assert.assertThat( matcher.group( 1 ), IsEqual.equalTo( "" ) );
